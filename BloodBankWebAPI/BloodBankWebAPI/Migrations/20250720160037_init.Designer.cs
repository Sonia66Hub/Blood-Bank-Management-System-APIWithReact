            ...
            modelBuilder.Entity("BloodBankWebAPI.Models.BloodInventory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            InventoryId = 1,
                            BloodGroupId = 1,
                            LastUpdated = new DateTime(2025, 7, 20, 22, 0, 36, 608, DateTimeKind.Local).AddTicks(167),
                            UnitsAvailable = 10
                        },
                        new
                        {
                            InventoryId = 2,
                            BloodGroupId = 2,
                            LastUpdated = new DateTime(2025, 7, 20, 22, 0, 36, 608, DateTimeKind.Local).AddTicks(178),
                            UnitsAvailable = 10
                        },
                        new
                        {
                            InventoryId = 3,
                            BloodGroupId = 3,
                            LastUpdated = new DateTime(2025, 7, 20, 22, 0, 36, 608, DateTimeKind.Local).AddTicks(179),
                            UnitsAvailable = 10
                        },
                        new
                        {
                            InventoryId = 4,
                            BloodGroupId = 4,
                            LastUpdated = new DateTime(2025, 7, 20, 22, 0, 36, 608, DateTimeKind.Local).AddTicks(180),
                            UnitsAvailable = 10
                        },
                        new
                        {
                            InventoryId = 5,
                            BloodGroupId = 5,
                            LastUpdated = new DateTime(2025, 7, 20, 22, 0, 36, 608, DateTimeKind.Local).AddTicks(181),
                            UnitsAvailable = 10
                        },
                        new
                        {
                            InventoryId = 6,
                            BloodGroupId = 6,
                            LastUpdated = new DateTime(2025, 7, 20, 22, 0, 36, 608, DateTimeKind.Local).AddTicks(182),
                            UnitsAvailable = 10
                        },
                        new
                        {
                            InventoryId = 7,
                            BloodGroupId = 7,
                            LastUpdated = new DateTime(2025, 7, 20, 22, 0, 36, 608, DateTimeKind.Local).AddTicks(183),
                            UnitsAvailable = 10
                        },
                        new
                        {
                            InventoryId = 8,
                            BloodGroupId = 8,
                            LastUpdated = new DateTime(2025, 7, 20, 22, 0, 36, 608, DateTimeKind.Local).AddTicks(185),
                            UnitsAvailable = 10
                        });
                });
            ...
            modelBuilder.Entity("BloodBankWebAPI.Models.Donor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "Dhaka",
                            BloodGroupId = 1,
                            CreatedAt = new DateTime(2025, 7, 20, 22, 0, 36, 608, DateTimeKind.Local).AddTicks(203),
                            DonorName = "John Doe",
